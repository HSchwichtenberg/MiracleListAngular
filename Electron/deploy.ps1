...
electron-packager temp_electron MiracleListElectron --platform=win32,linux --arch=x64 --out=dist_electron/ --overwrite --icon=Electron/src/img/favicon.ico --asar #win32,darwin,linux
"--> !!!FERTIG!!!"
cd $lok
