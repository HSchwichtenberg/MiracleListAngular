...
electron-packager temp_electron MiracleListElectron --platform=win32,linux --arch=x64 --out=dist_electron3/ --overwrite --icon=Electron/src/img/icon --asar #win32,darwin,linux
"--> !!!FERTIG!!!"
cd $lok
