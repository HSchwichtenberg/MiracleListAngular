...
export class AppComponent implements OnInit {
 ...
 // Lade die Liste der Aufgaben in einer Kategorie - vor TS 2.1 mit Observable.subscribe
 ...
 // Lade die Liste der Aufgaben in einer Kategorie - TS 2.1 mit async/await
